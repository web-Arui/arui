<template>
    <div id="detailCon" class="detail-acitve">
        <Header title="影片详情">
            <i class="iconfont icon-right" @touchstart="hendleBack"></i>
        </Header>
		...
		<div v-else id="content" class="contentDetail">
            ...
            <div class="detail_list">
				<div class="detail_list_bg" :style="{ 'background-image' : 'url('+detailMovie.img.replace(/w\.h/,'148.200')+')'}"></div>
				<div class="detail_list_filter"></div>
				<div class="detail_list_content">
					<div class="detail_list_img">
...
<style scoped>
    #detailCon{width: 100%;min-height: 100%;z-index: 100;background: white;position: absolute;left: 0;top: 0; }
    #detailCon.detail-acitve{animation: .4s sileMovie;}
    @keyframes sileMovie{
